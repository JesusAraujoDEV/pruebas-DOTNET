...
using LibrosApi.Services.Libro; // Para el servicio de Libro
using LibrosApi.Services.Autor; // Para el servicio de Autor (para validación)
using LibrosApi.Dtos.Libro; // Para los DTOs de Libro
